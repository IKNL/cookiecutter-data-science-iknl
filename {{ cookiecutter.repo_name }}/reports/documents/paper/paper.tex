...
\usepackage[pdftex]{graphicx}                 % Enable the use of .pdf graphics.
	\graphicspath{ ../../figures/ }         % Path where the figure files are located. Remember to add an extra set of curly braces, thus {{ ../../figures/ }} (Cookiecutter limitation)
...
\affil[a]{Netherlands Comprehensive Cancer Organization (IKNL), Eindhoven, NL}
